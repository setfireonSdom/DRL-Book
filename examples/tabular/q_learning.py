"""Off-policy Q-learning control on the tabular GridWorld."""
...
def run_q_learning(
    *,
    ...
    """Train a Q-learning agent on the negative GridWorld."""
    set_seed(seed)
...
def main() -> None:
    ...
    q_table, rewards_per_episode, update_counts = run_q_learning()
